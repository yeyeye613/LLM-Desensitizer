...
public class GeneralizationDesensitizationStrategy implements DesensitizationStrategy {
        ...
        for (SensitiveEntity entity : validEntities) {
            try {
                ...
                String replacement = contextRepository.getOrCreateConsistencyValue(sessionId, originalText, typeStr,
                        currentId -> "[" + generalizeValue(originalText, entity.getType()) + "_" + currentId + "]");
    ...
    // 深度遍历Map进行泛化替换
    private Map<String, Object> deepGeneralizeMap(Map<String, Object> map, SensitiveEntity entity,
            String generalization) {
